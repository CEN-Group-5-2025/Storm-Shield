...
export const VolunteerForm = () => {
  ...
  const locationOptions = [
    ...
    { value: "shelter_1", label: "San Juan Community Center", icon: <ShelterIcon /> },
    { value: "shelter_2", label: "Ponce Emergency Shelter", icon: <ShelterIcon /> },
    { value: "hospital_1", label: "Metro Hospital", icon: <HospitalIcon /> },
    { value: "school_1", label: "Mayagüez High School", icon: <SchoolIcon /> },
    { value: "comm_center", label: "Arecibo Convention Center", icon: <CommunityCenterIcon /> }
  ];

  // Work type options with icons
  const workTypeOptions = [
    { value: "medical", label: "Medical Assistance", icon: <MedicalIcon /> },
    { value: "construction", label: "Construction & Repair", icon: <ConstructionIcon /> },
    { value: "food", label: "Food Preparation & Distribution", icon: <FoodIcon /> },
    { value: "logistics", label: "Transportation & Logistics", icon: <LogisticsIcon /> },
    { value: "communication", label: "Communications Support", icon: <CommunicationIcon /> },
    { value: "it_support", label: "IT & Technical Support", icon: <ITSupportIcon /> },
    { value: "childcare", label: "Childcare Services", icon: <ChildcareIcon /> }
  ];
  ...
  const volunteerOpportunities: VolunteerMatch[] = [
    {
      ...
      location: "san_juan",
      workType: "medical",
      description: "Provide basic medical assistance at our San Juan community center for those affected by the recent flooding.",
    ...
    },
    {
      ...
      location: "shelter_1",
      workType: "food",
      description: "Help prepare and serve meals to displaced residents at the San Juan Community Center shelter.",
    ...
    },
    {
      ...
      description: "Join our team helping repair homes damaged by wind and flooding in the Ponce area.",
    ...
    },
    {
      ...
      location: "hospital_1",
      workType: "logistics",
      description: "Help organize and distribute medical supplies to those in need at Metro Hospital.",
    ...
    },
    {
      ...
      description: "Support emergency communications efforts at Arecibo Convention Center to help reconnect families.",
    ...
    },
    {
      ...
      location: "school_1",
      workType: "it_support",
      description: "Provide IT support for our emergency relief operations at Mayagüez High School.",
    ...
    },
    {
      ...
      location: "shelter_2",
      workType: "childcare",
      description: "Provide childcare services for families staying at the Ponce Emergency Shelter.",
  ...
  const handleFindMatch = () => {
    ...
    setTimeout(() => {
      ...
      const match = volunteerOpportunities.find(
        opp => opp.location === formData.location && opp.workType === formData.workType
      );

      // If no exact match, try to find match with just the work type
      const workTypeMatch = !match
        ? volunteerOpportunities.find(opp => opp.workType === formData.workType)
        : null;
    ...
    <div className="volunteer-form-page">
      <div className="volunteer-form-content">
        ...
        <main className="volunteer-form-main">
          <div className={`volunteer-form-header ${animateHeader ? 'animate' : ''}`}>
            <h1 className="page-title">Sign Up to be a Volunteer</h1>
            <p className="volunteer-form-subtitle">
              Help your community recover by offering your skills and time. Select your preferred location and the type of work you're interested in.
            </p>
          </div>

          <div className="volunteer-form-container">
            <div className="form-group">
              <label htmlFor="location" className="form-label">Where would you like to volunteer?</label>
            ...
            <div className="form-group">
              <label htmlFor="workType" className="form-label">What type of work would you like to do?</label>
              <div className="select-wrapper">
                <select
                  id="workType"
                  name="workType"
            ...
            <p className="form-info">
              Once matched, you'll receive information about the volunteer opportunity and contact details.
            </p>
          </div>
          ...
          {matchResult && (
            <div className="match-result">
              ...
              <div className="match-detail">
                <span className="match-detail-label">Opportunity:</span> {matchResult.name}
              </div>
              <div className="match-detail">
                <span className="match-detail-label">Location:</span> {getLocationLabel(matchResult.location)}
              </div>
              <div className="match-detail">
                <span className="match-detail-label">Type:</span> {getWorkTypeLabel(matchResult.workType)}
              </div>
              <div className="match-detail">
                <span className="match-detail-label">Description:</span> {matchResult.description}
              </div>

              <div className="match-contact">
                <h4>Contact Information</h4>
                <div className="match-detail">
                  <span className="match-detail-label">Name:</span> {matchResult.contactName}
                </div>
                <div className="match-detail">
                  <span className="match-detail-label">Email:</span> {matchResult.contactEmail}
                </div>
                <div className="match-detail">
                  <span className="match-detail-label">Phone:</span> {matchResult.contactPhone}
                </div>
              </div>
            </div>
          )}
