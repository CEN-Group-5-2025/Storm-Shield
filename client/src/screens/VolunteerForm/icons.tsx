...
export const ShelterIcon = () => (
  ...
  >
    <path
      d="M12 3L4 9V11H6V19H9V13H15V19H18V11H20V9L12 3ZM12 7.75C11.31 7.75 10.75 7.19 10.75 6.5C10.75 5.81 11.31 5.25 12 5.25C12.69 5.25 13.25 5.81 13.25 6.5C13.25 7.19 12.69 7.75 12 7.75Z"
      fill="#71C2CB"
    />
  </svg>
)
...
export const CommunityCenterIcon = () => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
...
export const MedicalIcon = () => (
  ...
  >
    <path
      d="M10.5 15H8V12.5H5.5V10H8V7.5H10.5V10H13V12.5H10.5V15ZM19 3H5C3.89 3 3 3.89 3 5V19C3 20.11 3.89 21 5 21H19C20.11 21 21 20.11 21 19V5C21 3.89 20.11 3 19 3ZM19 19H5V5H19V19Z"
      fill="#71C2CB"
    />
  </svg>
)
...
export const ConstructionIcon = () => (
  ...
  >
    <path
      d="M13.7826 15.1719L15.1962 13.7582L13.0696 11.6316L14.4833 10.218L12.3567 8.0914L13.7704 6.67773L11.6438 4.55117L10.2301 5.96484L8.10358 3.83828L6.68991 5.25195L8.81647 7.37851L7.4028 8.79218L9.52936 10.9187L8.11569 12.3324L10.2423 14.459L11.6559 13.0453L13.7826 15.1719ZM17.5 10L20 12.5V20H4V4H11.5L14 6.5H17.5V10Z"
      fill="#71C2CB"
    />
  </svg>
)
...
export const ChildcareIcon = () => (
  ...
  >
    <path
      d="M12.5 23.25C9.6 23.25 7.25 20.9 7.25 18V15H8.75V18C8.75 20.07 10.43 21.75 12.5 21.75C14.57 21.75 16.25 20.07 16.25 18V15H17.75V18C17.75 20.9 15.4 23.25 12.5 23.25ZM21.5 15H18.5V7C18.5 5.9 17.6 5 16.5 5H15.5V1.5H14V5H11V1.5H9.5V5H8.5C7.4 5 6.5 5.9 6.5 7V15H3.5C2.95 15 2.5 14.55 2.5 14V8C2.5 7.45 2.95 7 3.5 7H5.25V7C5.25 5.35 6.6 4 8.25 4H9.5V2.5C9.5 1.95 9.95 1.5 10.5 1.5H14.5C15.05 1.5 15.5 1.95 15.5 2.5V4H16.75C18.4 4 19.75 5.35 19.75 7V7H21.5C22.05 7 22.5 7.45 22.5 8V14C22.5 14.55 22.05 15 21.5 15Z"
      fill="#71C2CB"
    />
  </svg>
)
